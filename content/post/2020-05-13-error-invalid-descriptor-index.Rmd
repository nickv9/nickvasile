...
I then sourced all the .R files for each of these packages....

```{r, eval = FALSE}
# TODO: show this process
```

And then set breakpoints in some of the functions listed in the output of `traceback()`
