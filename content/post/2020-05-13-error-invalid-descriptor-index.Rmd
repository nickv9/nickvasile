...
TODO: if this is evaluated is causes blogdown::serve_site() to fail. Probably need to wrap the call in some sort of exception handling.
Read through: https://adv-r.hadley.nz/conditions.html 

```{r, eval = FALSE}
dplyr::tbl(con,"##problem_data")
```

Here the problem does not occur.
