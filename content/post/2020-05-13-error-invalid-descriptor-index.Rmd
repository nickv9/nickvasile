...
![](/post/2020-05-13-error-invalid-descriptor-index_files/dbFetch_breakpoint.png)

from this output I can see that `dbFetch()` is being invoked from line 583 of `backend-.R`

Note that I checked the box to, "Show Internals," which revealed `dplyr::tbl()` as the first function executed.

A search of the file system revealed that `backend-.R` is a file in the R direction of the dbplyr package.
