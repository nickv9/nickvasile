...
What I cannot see is what packages export these functions and where in the package code these functions are located.
...
Unfortunately off the top of my head I don't know what code I need.

I will try to build the packages, and source the files from those packages that export the following functions:
...
With the exception of dplyr, I am not sure what packages export these functions so I will have to search to find the packages.

TODO: find the packages that export these functions. First update R and all packages.
