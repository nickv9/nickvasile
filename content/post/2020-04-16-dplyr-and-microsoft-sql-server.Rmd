...
I will also not include comments about satabase management systems (DBMS) other than Microsoft SQL Server.
...
dbplyr translates dplyr code into Microsoft SQL Server specific SQL. 
...
DBI implements a standardized front-end, and the odbc package acts as a driver to interface with SQL Server.
